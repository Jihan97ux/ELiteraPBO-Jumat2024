...
CREATE TABLE `content_tbl` (
  ...
  `Content_Materi_id` varchar(7) DEFAULT NULL
...
INSERT INTO `content_tbl` (`Content_id`, `Content_desc`, `Content_url`, `Content_Materi_id`) VALUES
('t1', 'yeaheayeh dwaawd', 'files.elitera.id/files/course1/t1.mp4', 'PBO1'),
('PBO3VID1', 'Video Try and Exception', 'www.trynexception.com', 'PBO3'),
('ASD1DOC1', 'Dokumen 1 ASD1', 'www.doc1asd1.com', 'ASD1');
...
('KMPR1', 'Speed Up', 'KOMPAR', 'coba lagi'),
('PBO1', 'ENKAPSULASI', 'PBO', 'SETELAH EDIT'),
('PBO3', 'Try and Exception', 'PBO', 'Pembelajaran Try and Exception'),
('PBO4', 'GUI', 'PBO', 'Pembelajaran Interface Java GUI'),
('PBO5', 'Inheritence', 'PBO', 'pembelajaran inheritence'),
('PBO8', 'Static variable', 'PBO', 'stst');
...
('aika@gmail.com', 'aika', 'imali', 'SMK', 'Informatika', 11, 'aika'),
('alabama@gmail.com', 'alba', 'abama', 'SMK', 'Akuntasi', 12, 'albagtg'),
('cobalagisih', 'coba', 'lagi', 'SMA', 'IPS', 10, 'gtw13'),
('ekal@gmail.com', 'ekal', 'ekal', 'SMK', 'Informatika', 10, 'ekal'),
...
('sarah@gmail.com', 'sarah', 'diane', 'SMK', 'Informatika', 11, 'saraha');
...
('KOMPAR', 'Komputasi paralel', 'pembelajarn kompar', 'Informatika', '22356378'),
...
('PBO', 'PBO', 'Pemrograman Berorientasi Objek', 'Informatika', '22356378'),
